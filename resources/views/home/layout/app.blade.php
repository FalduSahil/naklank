...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ getPath('home') }}/images/favicon/favicon.ico"/>
    ...
    <div class="offcanvas-body">
        <div>
            ...
            <div class="alert alert-danger p-2" role="alert">
                ...
                <a href="index-3.html#!" class="alert-link">checkout now!</a>
            </div>
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item py-3 ps-0 border-top">
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                            <div class="d-flex">
                                <img src="{{ getPath('home') }}/images/products/product-img-1.jpg" alt="Ecommerce"
                                ...
                                <div class="ms-3">
                                    ...
                                    <div class="mt-2 small lh-1">
                                        <a href="index-3.html#!" class="text-decoration-none text-inherit">
                ...
                <li class="list-group-item py-3 ps-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                            <div class="d-flex">
                                <img src="{{ getPath('home') }}/images/products/product-img-2.jpg" alt="Ecommerce"
                                     class="icon-shape icon-xxl"/>
                                <div class="ms-3">
                                    <a href="shop-single.html" class="text-inherit">
                ...
                <li class="list-group-item py-3 ps-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                            <div class="d-flex">
                                <img src="{{ getPath('home') }}/images/products/product-img-3.jpg" alt="Ecommerce"
                                     class="icon-shape icon-xxl"/>
                                <div class="ms-3">
                                    <!-- title -->
                                    <a href="shop-single.html" class="text-inherit">
                ...
                <li class="list-group-item py-3 ps-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                            <div class="d-flex">
                                <img src="{{ getPath('home') }}/images/products/product-img-4.jpg" alt="Ecommerce"
                                     class="icon-shape icon-xxl"/>
                                <div class="ms-3">
                                    <!-- title -->
                                    <!-- title -->
                ...
                <li class="list-group-item py-3 ps-0 border-bottom">
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                            <div class="d-flex">
                                <img src="{{ getPath('home') }}/images/products/product-img-5.jpg" alt="Ecommerce"
                                     class="icon-shape icon-xxl"/>
                                <div class="ms-3">
                                    <!-- title -->
                                    <a href="shop-single.html" class="text-inherit">
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="index-3.html#!" class="btn btn-primary">Continue Shopping</a>
                <a href="index-3.html#!" class="btn btn-dark">Update Cart</a>
            </div>
        </div>
    </div>
</div>
